...
- methylation difference of locus $i$ between regions $s$ and $s'$: $$\beta_i = \pi_{is} - \pi_{is'}$$ 
...
- six samples of normal human dendritic cells, partitioned into groups of two or three $\rightarrow$ no DMRs


- 3000 simulated DMRs added to each data set
 

- methylation data from several human tissues and from two mouse strains
